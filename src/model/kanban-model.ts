...
export function toKanbanResponse(Kanban: any): KanbanResponse {
  return {
    ...
    total_stock_out_quantity: Kanban.total_stock_out_quantity,
    stock_status:
      Kanban.min_quantity == null || Kanban.max_quantity == null
        ? "uncompleted"
        : Kanban.balance < Kanban.min_quantity
        ? "Understock"
        : Kanban.balance > Kanban.max_quantity
        ? "Overstock"
        : "Normal",
    incoming_order_stock: Kanban.incoming_order_stock,
    is_completed:
      Kanban.specification == null ||
      Kanban.description == null ||
      Kanban.currency == null ||
      Kanban.price == null ||
      Kanban.safety_stock == null ||
      Kanban.order_point == null ||
      Kanban.min_quantity == null ||
      Kanban.max_quantity == null ||
      Kanban.uom == null ||
      Kanban.lead_time == null ||
      Kanban.rack_id == null ||
      Kanban.machine_area_id == null ||
      Kanban.machine_id == null ||
